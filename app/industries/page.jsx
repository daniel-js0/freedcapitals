  ...
  return (
    <main>
      <div className='w-[100%] h-[70%] relative'>
        ...
        <h1 className='text-3xl font-semibold absolute text-slate-200 top-0'>We collaborate with Various industries to provide tailored solution to our clients</h1>

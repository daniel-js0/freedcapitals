...
export default function Home() {
  return (
    <main className="mt-14 mb-32">
     ...
     <div className="mt-12 w-[95%] h-[16rem] md:h-[30rem] mx-auto bg-slate-400">
        <div className="w-[30%] h-[100%] bg-red-400">
          ...
          <h1 className="text-center">Empower individuals</h1>
          <p className="text-center">We believe in ideas of our clients</p>
        </div>

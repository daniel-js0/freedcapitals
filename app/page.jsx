  ...
  return (
    <main className="mt-14 mb-32">
      <div className="md:flex">
          <svg className="md:-ml-4 md::mt-12 hidden md:flex " xmlns="http://www.w3.org/2000/svg" width="140" height="180" viewBox="0 0 128 128" fill="none">
          ...
          <div className="ml-7 h-44 w-[80%] bg-slate-5 relative z-30">
            <h1 className="md:text-6xl text-3xl font-semibold text-center md:px-[0.7rem] leading-snug tracking-wide">Empowering Industries with Bespoke Solutions Tailored to their Needs </h1>
            <p className="lg:text-2xl md:text-lg  lg:font-light tracking-wide leading-relaxed text-gray-400 text-center mt-3  h-12 lg:w-[70%] mx-auto"> Our goal at Freed Capitals is to break free of norms, uncover new opportunities, and help create lasting solutions. </p>
            <div className="h-7 lg:w-[32%] md:w-[55%] bg-[#39B7B3] absolute md:top-10 md:start-32 lg:top-14 lg:start-4 -z-10"></div>
            <div className="h-7 w-[21%] bg-[#39B7B3]  absolute top-14 end-4 -z-10"></div>
            <div className="h-7 w-[24%] bg-[#39B7B3] absolute top-[8.3rem] start-[4.5rem] -z-10"></div>
            <div className="h-7 w-[32%] bg-[#39B7B3] absolute top-[8.3rem] end-[4.5rem] -z-10"></div>
          </div>
      </div>
      <div className="mt-5">

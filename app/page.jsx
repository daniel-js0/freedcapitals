    ...
    <main className="mt-14 mb-32">
      <div className="lg:flex">
          ...
          <div className="ml-7 h-44 w-[80%] bg-slate-5 relative z-30">
            <h1 className="md:text-6xl text-3xl font-semibold text-center lg:px-[0.7rem] md:leading-snug md:tracking-wide">Empowering Industries with Bespoke Solutions Tailored to their Needs </h1>

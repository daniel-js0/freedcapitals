  ...
  return (
    <main className="mt-14 mb-32">
      <div className="lg:flex">
          <svg className="lg:-ml-4 lg:mt-12 hidden lg:flex " xmlns="http://www.w3.org/2000/svg" width="140" height="180" viewBox="0 0 128 128" fill="none">
          ...
          <div className="ml-7 h-44 w-[80%] bg-slate-5 relative z-30">
            <h1 className="lg:text-6xl text-3xl font-semibold text-center lg:px-[0.7rem] leading-snug tracking-wide">Empowering Industries with Bespoke Solutions Tailored to their Needs </h1>
            <p className="lg:text-2xl  lg:font-light tracking-wide leading-relaxed text-gray-400 text-center mt-3  h-12 lg:w-[70%] mx-auto"> Our goal at Freed Capitals is to break free of norms, uncover new opportunities, and help create lasting solutions. </p>
            <div className="h-7 w-[32%] bg-[#39B7B3] absolute top-14 start-4 -z-10"></div>
      ...
      <div>
          <Image src="/home1.png" width={627} height={410} quality={100} alt="freedcapital logo" placeholder="empty"
                   className='mt-40 w-[90%] lg:h-[35rem] h-[10rem] mx-auto '  /> 
     </div>

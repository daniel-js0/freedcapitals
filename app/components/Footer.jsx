  ...
  return (
   <main>
     <div className='w-screen'>
      ...
      <div className='mt-5 w-[70%]   mx-auto text-gray-700'>
      ...
      <div className='flex justify-between mx-auto mt-7 w-[70%] h-10'>
      ...
      <div className='h-[0.010rem] mx-auto mt-5 w-[95%] bg-gray-500 '></div>

      <p className='mt-3 mb-4 text-center text-gray-600'>© 2023 Freed Capitals. All right reserved.</p>

   ...
   <main >
     <div className='w-screen '>
      ...
      <div className='relative'>
          ...
          <svg className=' hidden lg:flex absolute -top-16 start-[20rem] opacity-20' xmlns="http://www.w3.org/2000/svg" width="651" height="427" viewBox="0 0 651 427" fill="none">
          ...
          <svg className=' hidden lg:flex absolute top-48 start-[34rem]  opacity-20' xmlns="http://www.w3.org/2000/svg" width="204" height="163" viewBox="0 0 204 163" fill="none">
          ...
          <svg className='hidden lg:flex absolute top-16 start-[28rem]  opacity-20' xmlns="http://www.w3.org/2000/svg" width="219" height="174" viewBox="0 0 219 174" fill="none">
            <path d="M187.688 0.120535L0.538086 129.12L30.9465 173.236L218.096 44.2366L187.688 0.120535Z" fill="#39B7B3"/>
          </svg>
